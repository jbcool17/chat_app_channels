...
Message.create :date => Time.now, :user => "Beaker", :message => "Good Mate", :color => "#0011aa", :channel_name => "live"
Message.create :date => Time.now, :user => "Jake", :message => "OOoo nice", :color => "#00aa00", :channel_name => "live"
Message.create :date => Time.now, :user => "Beaker", :message => "Yea yoou??", :color => "#0011aa", :channel_name => "live"
Message.create :date => Time.now, :user => "Jake", :message => "Couldn't be better, couldn't be better", :color => "#00aa00", :channel_name => "live"
Message.create :date => Time.now, :user => "Beaker", :message => "Nice", :color => "#0011aa", :channel_name => "live"
...
Message.create :date => Time.now, :user => "Beaker", :message => "OOoh i think they alrdy came...!", :color => "#0011aa", :channel_name => "live"
...
Message.create :date => Time.now, :user => "Beaker", :message => "Good Mate", :color => "#0011aa", :channel_name => "manual"
Message.create :date => Time.now, :user => "Jake", :message => "OOoo nice", :color => "#00aa00", :channel_name => "manual"
Message.create :date => Time.now, :user => "Beaker", :message => "Yea yoou??", :color => "#0011aa", :channel_name => "manual"
Message.create :date => Time.now, :user => "Jake", :message => "Couldn't be better, couldn't be better", :color => "#00aa00", :channel_name => "manual"
Message.create :date => Time.now, :user => "Beaker", :message => "Nice", :color => "#0011aa", :channel_name => "manual"
...
Message.create :date => Time.now, :user => "Beaker", :message => "OOoh i think they alrdy came...!", :color => "#0011aa", :channel_name => "manual"
...
Message.create :date => Time.now, :user => "Beaker", :message => "Good Mate", :color => "#0011aa", :channel_name => "websockets"
Message.create :date => Time.now, :user => "Jake", :message => "OOoo nice", :color => "#00aa00", :channel_name => "websockets"
Message.create :date => Time.now, :user => "Beaker", :message => "Yea yoou??", :color => "#0011aa", :channel_name => "websockets"
...
Message.create :date => Time.now, :user => "Beaker", :message => "Nice", :color => "#0011aa", :channel_name => "websockets"
...
Message.create :date => Time.now, :user => "Beaker", :message => "OOoh i think they alrdy came...!", :color => "#0011aa", :channel_name => "websockets"
Message.create :date => Time.now, :user => "Rolphie", :message => "Yea they came for dinner", :color => "#aa0000", :channel_name => "websockets"

User.create name: 'user1', color: '#5bacff'
